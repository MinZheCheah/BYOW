...
public class Tileset {
    ...
    public static final TETile FOOD = new TETile('\u2615', Color.orange, Color.black, "a cup of java!", 13);
    public static final TETile PLAYER = new TETile('☺', Color.green, Color.black, "you", 14);
    public static final TETile ENEMY = new TETile('☹', Color.magenta, Color.black, "enemy", 15);
}
